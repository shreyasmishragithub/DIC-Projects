...
plt.plot(x_values, y_values, color = 'red', label = 'Real Covid19 Confirmed Case')
plt.plot(x_values, predicted_confirmed_rate, color = 'blue', label = 'Predicted Covid19 Confirmed Case')
...
df = pd.read_csv('covidIndiamade.csv', usecols = ['Confirmed'])
...
df_old = pd.read_csv('covidIndia1.csv', usecols = ['Date', 'Confirmed'])
...
plt.plot(df, color = 'red', label = 'Real Covid19 Confirmed Case')
plt.plot(copy, color = 'blue', label = 'Predicted Covid19 Confirmed Case')
plt.title('India Covid19 Daywise Confirm Prediction')
